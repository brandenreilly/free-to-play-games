...
export const Display = () => {
    ...
    const getFilteredGames = (keyword) => {
            ...
            <div className="col-9">
                <div className="row mx-auto d-flex justify-content-center">
                    {games ? games.slice(0, 16).map((data, ind)=>{
                        return (
                            <div className="col-lg-3 col-md-6 col-xs-1 d-flex justify-content-center mx-0 mb-3 p-0 overflow-auto">
                                <div className="card card-styling" style={{width: "17rem"}} key={ind}>
